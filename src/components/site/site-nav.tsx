    ...
    <header className="border-border bg-background/75 sticky top-0 z-40 w-full border-b backdrop-blur-md backdrop-saturate-150">
      <div className="mx-auto flex h-14 max-w-6xl items-center gap-4 px-4 sm:px-6 lg:px-8">
        ...
        >
          <span
            aria-hidden="true"
            className="border-border bg-surface-inset text-foreground group-hover:border-border-strong grid size-7 place-items-center rounded-md border text-[11px] tracking-wider transition-colors"
          >
            {siteConfig.initials}
          </span>
