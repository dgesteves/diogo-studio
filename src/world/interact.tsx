...
/**
 * Picking. R3F raycasts its own events, so every selectable object registers itself here and
 * this is what turns a hit into a route push or an agent open. The registry is a module
 * singleton because the scene graph is one.
 */
