...
/**
 * The mark on the lid, at the size the machine prints it and in its own finish. The picture
 * itself is shared with the MacBook in the lounge and lives in `scene/mark.ts`.
 */
