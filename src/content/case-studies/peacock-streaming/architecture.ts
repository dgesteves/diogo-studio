...
export const architecture: readonly ArticleBlock[] = [
  { kind: "heading", level: 2, text: "What the surface actually was" },
  {
    kind: "paragraph",
    text: "Peacock's web property is the non-player half of the streaming experience: auth, sign-up, billing, account, content browse, error recovery, deep-linking from native apps. None of it is glamorous in isolation; in aggregate it's the surface that decides whether a viewer ever reaches the player on Sunday afternoon.",
  },
  {
    kind: "paragraph",
    text: 'The work was less "design a system" and more "operate a system that already exists at scale, without making it worse." This was where I internalized that for senior engineers in operating-scale companies, the unsexy parts — release safety, observability, runbooks — *are* the craft.',
  },
  { kind: "heading", level: 2, text: "Architecture (the relevant slice)" },
  {
    kind: "diagram",
    title: "Peacock web surface slice",
    description:
      "React clients call internal BFFs which talk to identity, billing, and catalog services. Telemetry flows to Splunk + Datadog; feature flags + canary gating decouple deploys from releases.",
