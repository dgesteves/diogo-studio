...
export function HeroSection(): ReactElement {
  ...
  return (
    <article className="world-intro-rise border-border/70 bg-background/80 supports-backdrop-filter:bg-background/60 pointer-events-auto flex w-full max-w-xl flex-col items-start gap-6 rounded-2xl border p-6 text-left shadow-2xl backdrop-blur-xl sm:p-8">
